  ...
  return (
    <div className="control-panel">
      ...
      <div className="model-card">
        <div className="model-card__head"><div className="model-glyph">{inferenceProvider === 'chrome' ? 'AI' : selectedModel.shortLabel}</div><div><strong>{activeModelLabel}</strong><span>{inferenceProvider === 'chrome' ? 'Gemini Nano · browser managed' : `LiteRT-LM · WebGPU · ${selectedModel.contextTokens.toLocaleString()} context`}</span></div><span className="model-size">{inferenceProvider === 'chrome' ? 'Managed' : selectedModelSize}</span></div>
